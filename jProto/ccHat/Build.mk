...
#      Source      : $Source: /Master/jWrap/jProto/ccHat/Build.mk,v $
#
...
# ----------------------------------------
${INCDIR}/libBackendCcHat.i: $(LIB_SRCXXS:%.cxx=${DEPDIR}/%.i)
	${protoRule}

# Set library & subLib name and give source depending files
# ----------------------------------------------------------
${LIBDIR}/libBackendCcHat${LIB_SFX}: ${LIB_OBJS}
	${libRule}
